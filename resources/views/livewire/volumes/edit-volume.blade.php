                ...
                <div class="card-body">
                    <form method="POST" wire:submit.prevent="save">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input id="isbn" type="text" class="form-control @error('volume.isbn') is-invalid @enderror" name="isbn" wire:model.debounce.500ms='volume.isbn' required autocomplete="isbn" autofocus>
                                @error('volume.isbn')
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <div class="input-group">
                                    <input id="price" type="text" class="form-control @error('volume.price') is-invalid @enderror" name="price" wire:model='volume.price' autocomplete="price" autofocus>
