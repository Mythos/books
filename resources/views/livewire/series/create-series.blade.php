                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-check">
                                <input id="series.subscription_active" type="checkbox" class="form-check-input @error('series.subscription_active') is-invalid @enderror" name="subscription_active" wire:model='series.subscription_active' @if ($series->status == 3) disabled @endif>
